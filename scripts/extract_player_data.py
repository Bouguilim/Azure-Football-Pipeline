...
from utils.constants import PLAYER_PROFILE_PATH, PROCESSED_PLAYER_URLS_PATH
...
async def main(urls) -> None:
    ...
    try:
        output_file = PLAYER_PROFILE_PATH
        processed_urls_file = PROCESSED_PLAYER_URLS_PATH
...
if __name__ == "__main__":
    ...
    PL = ["https://www.transfermarkt.com/wettbewerb/startseite/wettbewerb/GB1"]
